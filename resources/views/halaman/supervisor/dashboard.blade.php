...
<body class="g-sidenav-show  bg-gray-200">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="{{ route('supervisorDashboard') }}" target="_self">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="{{ route('supervisorDashboard') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('pegawaiSupervisor.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="{{ route('userSupervisor.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">table_view</i>
                        </div>
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Supervisor</h6>
                </nav>
                <div class="px-4">
                    ...
                    <div class="card z-index-2  ">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                            <div class="bg-gradient-dark shadow-success border-radius-lg py-3 pe-1">
                                <div class="chart">
                                <canvas id="genderPieChart" class="chart-canvas" height="170"></canvas>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <h6 class="mb-0 "> Pie Chart </h6>
                            <p class="text-sm ">Jumlah Pegawai Berdasarkan Kelamin</p>
                ...
                <div class="col-lg-4 mt-4 mb-3">
                    <div class="card z-index-2 ">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-sm ">Jumlah Pegawai Berdasarkan Jabatan</p>
                            <hr class="dark horizontal">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                ...
                                <h4 class="mb-0">{{ $tPegawai }}</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            <p class="mb-0">Jumlah Semua Pegawai</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        ...
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            <p class="mb-0">Jumlah Semua User</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">Total Supervisor</p>
                                <h4 class="mb-0">{{ $tSupervisor }}</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            <p class="mb-0">Jumlah Semua Supervisor</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-lg-6 mb-lg-0 mb-4">
                            <div class="copyright text-center text-sm text-muted text-lg-start">
                                ...
                                <a href="#" class="font-weight-bold" target="_blank">Aria Saputra</a>
    ...
    <script>
        ...
        var genderPieChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: "Jumlah",
                    data: [{{ $jumlahLakiLaki ?? 0 }}, {{ $jumlahPerempuan ?? 0 }}],
                    backgroundColor: [
                        'rgba(54, 162, 235, 0.6)',
                        'rgba(255, 99, 132, 0.6)'
                    ],
        ...
        new Chart(ctx3, {
            type: "line",
            data: {
                labels: ["Kepala Sekolah", "Staff", "Guru"],
                datasets: [{
                    label: "Jumlah",
                    tension: 0,
                    borderWidth: 0,
                    ...
                    fill: true,
                    data: [{{$jumlahKepala ?? 0}}, {{$jumlahStaff?? 0}}, {{$jumlahGuru ?? 0}}],
                    maxBarThickness: 6

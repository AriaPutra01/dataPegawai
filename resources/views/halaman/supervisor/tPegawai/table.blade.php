    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="{{ route('pegawaiSupervisor.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <table id="example1" class="table table-bordered align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('/storage/pegawais/'.$p->foto) }}" alt="foto" class="avatar avatar-sm me-3 border-radius-lg">
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('pegawaiSupervisor.show', $p->id) }}" class="btn btn-sm btn-info">SHOW</a>
                                    </td>
                                </tr>
                                @empty

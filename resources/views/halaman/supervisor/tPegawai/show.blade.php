...
<body class="g-sidenav-show  bg-gray-200">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('supervisorDashboard') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active" href="{{ route('pegawaiSupervisor.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Menampilkan Data Pegawai</li>
        ...
        <a href="{{ route('pegawaiSupervisor.index') }}" class="btn btn-md btn-info">Kembali</a>
            <div class="row">
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm rounded">
                        <div class="card-body">
                            <img src="{{ asset('/storage/pegawais/'.$pegawai->foto) }}" class="rounded" style="width: 100%">
                        </div>
                    </div>
                </div>
                <div class="col-md-4"  style="margin-top: 20px;">
                    <div class="card border-0 shadow-sm rounded">
                        <div class="card-body">
                            <h3>{{ $pegawai->nama }}</h3>
                            <p>{{ $pegawai->tempatLahir }}, {{ $pegawai->tglLahir }}</p>
                            <p><p>{{ $pegawai->alamat }}</p></p>
                        </div>
                    </div>
                </div>

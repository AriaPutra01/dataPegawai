    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="{{ route('pegawaiAdmin.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="card my-4 border-0 shadow-sm rounded">
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive p-0">
                        <a href="{{ route('pegawaiAdmin.create') }}" class="btn btn-md btn-success mb-3">TAMBAH PEGAWAI</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('pegawaiAdmin.destroy', $p->id) }}" method="POST">
                                            <a href="{{ route('pegawaiAdmin.show', $p->id) }}" class="btn btn-sm btn-info">SHOW</a>
                                            <a href="{{ route('pegawaiAdmin.edit', $p->id) }}" class="btn btn-sm btn-warning">EDIT</a>
                                            @csrf
                                            @method('DELETE')

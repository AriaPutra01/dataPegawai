    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Buat Data Pegawai</li>
        ...
        <div class="container-fluid py-4">
            <div class="card border-0 shadow-sm rounded">
                <div class="card-body">
                    <form action="{{ route('pegawaiAdmin.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tglLahir') is-invalid @enderror" name="tglLahir" value="{{ old('tglLahir') }}" placeholder="Masukkan Tanggal Lahir Anda">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select @error('kelamin') is-invalid @enderror" name="kelamin" value="{{ old('kelamin') }}" aria-label="Default select example">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select @error('jabatan') is-invalid @enderror" name="jabatan" value="{{ old('jabatan') }}" aria-label="Default select example">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" class="form-control @error('mulaiMasuk') is-invalid @enderror" name="mulaiMasuk" value="{{ old('mulaiMasuk') }}" placeholder="Masukkan Tanggal Masuk Kerja Anda">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('job') is-invalid @enderror" name="job" rows="5" placeholder="Masukkan Job Anda">{{ old('job') }}</textarea>
                        ...
                        <button type="submit" class="btn btn-md btn-success me-3">SAVE</button>
        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body pt-sm-3 pt-0">
                ...
                <div class="w-100 text-center">
                    ...
                    <a href="https://wa.me/6283185741176" class="btn btn-dark mb-0 me-2" target="_blank">
                        <i class="fab fa-whatsapp me-1" aria-hidden="true"></i> whatsapp
                    </a>
                    <a href="https://www.instagram.com/kacaumennz/" class="btn btn-dark mb-0 me-2" target="_blank">

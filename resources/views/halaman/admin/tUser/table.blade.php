    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('pegawaiAdmin.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white bg-gradient-primary" href="{{ route('userAdmin.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">table_view</i>
                        </div>
            ...
            <div class="card my-4 border-0 shadow-sm rounded">
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive p-0">
                        <a href="{{ route('userAdmin.create') }}" class="btn btn-md btn-success mb-3">TAMBAH USER</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('userAdmin.destroy', $u->id) }}" method="POST">
                                            <a href="{{ route('userAdmin.show', $u->id) }}" class="btn btn-sm btn-info">SHOW</a>
                                            <a href="{{ route('userAdmin.edit', $u->id) }}" class="btn btn-sm btn-warning">EDIT</a>
                                            @csrf
                                            @method('DELETE')
